...
function (acq::PostVarAcq)(::Type{<:ExperimentDataMAP}, bolfi::BolfiProblem{<:Any, Nothing}, options::BolfiOptions)
...
function (acq::PostVarAcq)(::Type{<:ExperimentDataBI}, bolfi::BolfiProblem{<:Any, Nothing}, options::BolfiOptions)
    return posterior_variance(bolfi; normalize=false)
end
